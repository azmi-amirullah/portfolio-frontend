...
export function Table<T>({
  ...
  return (
    <div
      className={`bg-white shadow overflow-x-auto rounded-lg border border-gray-200 ${
        ...
        <thead className='bg-gray-50'>
          <tr>
            {columns.map((col, idx) => (
              <th
                key={idx}
                className={`${paddingClass} font-bold text-gray-500 uppercase tracking-wider ${
                  col.align === 'center'
                    ? 'text-center'
                    : col.align === 'right'
                    ? 'text-right'
            ...
            <tr>
              <td
                ...
                className={`text-center ${
                  size === 'sm' ? 'px-3 py-4 text-gray-500' : 'px-6 py-12'
                }`}
              >
                {size === 'sm' ? (
                  emptyState.title
