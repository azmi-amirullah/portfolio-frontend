        ...
        <div className='space-y-6'>
            ...
            <div className='grid grid-cols-1 gap-4 sm:grid-cols-2'>
                ...
                <div>
                    ...
                    <div
                        className={`mt-1 block w-full px-3 py-2 bg-gray-50 border border-gray-300 rounded-md ${margin > 0
                                ? 'text-green-600'
                                : margin < 0
                                    ? 'text-red-600'
                                    : 'text-gray-500'
                                ...
                                <div key={batch.addedDate} className='p-4 bg-white'>
                                    <div className='grid grid-cols-2 gap-4'>
                                        <div>
                                            ...
                                            <div
                                                className={`${batch.isSoldOut ? 'line-through text-gray-400' : 'text-gray-500'}`}
                                            >
                                        ...
                                        <div>
                                            ...
                                            <div
                                                className={`${batch.isSoldOut ? 'line-through text-gray-400' : 'text-blue-600'}`}
                                            >
                                                {batch.quantity}
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <span
                                                className={`text-base ${batch.isSoldOut ? 'text-red-600' : 'text-green-600'
                                                    }`}
                                            >
