...
interface PaymentModalProps {
  isOpen: boolean;
  totalAmount: number;
  onConfirm: (paymentDetails: { amountPaid: number }) => void;
  onCancel: () => void;
}
            ...
            <div>
              ...
              <div className='relative'>
                ...
                <input
                  ...
                  placeholder='0'
                  className='block w-full pl-12 pr-4 py-4 text-2xl font-bold  border border-gray-200 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-blue-600 transition-all'
                  min='0'
                />
              </div>
            </div>
