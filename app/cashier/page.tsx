  ...
  return (
    <AnimatePresence mode='wait'>
      {showTurnstile ? (
        ...
        <div
          key='login'
          className='min-h-dvh flex items-center justify-center bg-gray-50 px-4'
        >
          <motion.div
          ...
          >
                ...
                <div>
                  ...
                  <div className='mt-1 relative rounded-md shadow-sm'>
                    ...
                    <input
                      ...
                      className='block w-full pl-10 pr-10 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-blue-600'
            ...
            <div className='bg-blue-50 border border-blue-200 rounded-lg py-2 px-4'>
              ...
              <div className='text-blue-800'>
                <p>
                  <span className='font-medium'>Username:</span> guest
                </p>
                <p>
            ...
            <div className='text-center'>
              <p className='text-gray-500'>
                &copy; {new Date().getFullYear()} Mohd Azmi Amirullah A. All
                rights reserved.
              </p>
            </div>
          </motion.div>
